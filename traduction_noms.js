...
document.getElementById('nom_antiVibration').innerHTML = chrome.i18n.getMessage("Anti_vibration");
document.getElementById('liste_antiVibration').options[0].text = chrome.i18n.getMessage("Oui");
document.getElementById('liste_antiVibration').options[1].text = chrome.i18n.getMessage("Non");
...
document.getElementById('nom_flou_avantPlan').innerHTML = chrome.i18n.getMessage("FlouAvant");
document.getElementById('nom_flou_arrierePlan').innerHTML = chrome.i18n.getMessage("FlouArriere");
